...
parser.add_argument('--attack', type=str, default='badnets',
                    choices=['badnets', 'trojan-sq', 'trojan-wm', 'l0-inv', 'l2-inv', 'a2a', 'clb', 'blend', 'wanet'])
...
def main():
    ...
    if args.attack == 'badnets':
        ...
        x_poi_test, y_poi_test = patching_test(x_test, y_test, 'a2a', target_lab=0, adversarial=False,
    ...
    clean_val_loader = DataLoader(clean_val, batch_size=args.batch_size, shuffle=False, sampler=random_sampler,
                                  num_workers=0)
    ...
    for i in range(args.shrink_steps):
        ...
        train_loss, train_acc = shrink(model=net, criterion=criterion, data_loader=clean_val_loader,
