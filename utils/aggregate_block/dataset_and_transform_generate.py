...
def get_input_shape(dataset_name : str) -> Tuple[int, int, int]:
    ...
    if dataset_name == "cifar10":
        ...
        input_width = 64
        input_channel = 3
    elif dataset_name == 'imagenet' or dataset_name == 'imagenet200' or dataset_name == 'imagenet100':
        input_height = 224
        input_width = 224
        input_channel = 3
    else:
...
def dataset_and_transform_generate(args):
    ...
    if not os.path.exists(args.dataset_path):
        ...
        args.dataset_path = os.path.join(os.getcwd(), tmp.split('/')[1], tmp.split('/')[2])
    ...
    if (train_dataset_without_transform is None) or (test_dataset_without_transform is None):
        ...
        elif args.dataset == "imagenet" or args.dataset == "imagenet100" or args.dataset == "imagenet200":
