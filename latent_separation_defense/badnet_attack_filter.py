...
def main():
    ...
    torch.save(test_pidx,
               args.save_path + '/test_pidex_list.pickle',
               )
    ...
    if 'load_path' not in args.__dict__:
        ...
        # dict_save = {"attack_args": args}
        # torch.save(dict_save, '../record/' + args.load_path + "/dict_save.pt")
        #
        # load_dict = torch.load('../record/' + args.load_path + "/dict_save.pt")
        #
        # gggg = load_dict["attack_args"]
        ...
        # quantum.path_test(args)
        # lid4TargetClass(args, net, adv_train_ds, args.attack_target, device)
        # get_FinalAUM(args, adv_train_ds, net, device)
